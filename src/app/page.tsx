      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-950 via-green-900 to-green-800">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-20 md:py-28">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-green-700 hover:bg-green-800 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 text-sm transition-all shadow-sm hover:shadow-md"
            >
          ...
          {[
            {
              ...
              icon: Search,
              title: 'Search & filter',
              desc: 'Find cars by city, date, type, and budget. Hundreds of options across Azerbaijan.',
            },
            {
              step: '02',
              icon: Clock,
              title: 'Book instantly',
              desc: 'Confirm your booking online. No paperwork, no waiting — just a quick confirmation.',
            },
            {
              step: '03',
              icon: CarIcon,
              title: 'Pick up & drive',
              desc: 'Meet the owner or get airport delivery. Keys in hand, hit the road.',
            },
