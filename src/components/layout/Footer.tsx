...
export default function Footer() {
  return (
    <footer className="bg-green-950 text-green-200/60 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-white font-bold text-lg" style={{fontFamily: 'var(--font-display)'}}>AvtoGo</span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs text-green-200/50">
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-green-200/40">
