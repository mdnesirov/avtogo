...
export default function HomeHero({ featuredCars }: { featuredCars: Car[] | null }) {
    ...
    <div className="bg-[#faf9f6]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-950 via-green-900 to-green-800">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-20 md:py-28">
          ...
          <h1
            className="text-4xl md:text-6xl font-bold leading-[1.1] mb-5 text-white"
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { icon: Shield, text: t.homeTrust1, sub: t.homeTrust1sub },
            { icon: Star,   text: t.homeTrust2, sub: t.homeTrust2sub },
            { icon: MapPin, text: t.homeTrust3, sub: t.homeTrust3sub },
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        {featuredCars && featuredCars.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-base font-medium text-gray-500 mb-1">{t.homeEmptyTitle}</p>
            <p className="text-sm text-gray-400 mb-4">{t.homeEmptyDesc}</p>
      ...
      <section className="bg-white border-y border-gray-100 py-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-3 gap-8">
          {[
            { step: '01', icon: Search,  title: t.homeHow1Title, desc: t.homeHow1Desc },
